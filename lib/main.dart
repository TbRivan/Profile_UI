            ...
            child: Center(
              child: Column(
                children: <Widget>[
                  ...
                  text("Tubagus Rivan", 32),
                  const Padding(padding: EdgeInsets.only(bottom: 5)),
                  text("tbrivan22@gmail.com", 16),
                  const Padding(padding: EdgeInsets.only(bottom: 5)),
                  text("tubagus.065119122@unpak.ac.id", 16),
                  const Padding(padding: EdgeInsets.only(bottom: 5)),
                  text("081210903429", 16),
                  ...
                  Container(
                    ...
                    child: Row(children: const <Widget>[
                      ...
                      Text("Tubagus Rivan Maulana Sidiq",
                          style: TextStyle(
                            color: Colors.grey,
                            fontSize: 14,
                            fontWeight: FontWeight.bold,
                  ...
                  Container(
                    ...
                    child: Column(
                        ...
                        children: const <Widget>[
                          ...
                          Text(
                              "Kp Gugunung, Desa Banjarsari, Kecamatan Ciawi,     ",
                              style: TextStyle(
                                color: Colors.grey,
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
